...
public class OrderBLService_Driver {
	...
	public void drive(OrderBLService orderBLService) {
		...
		int roomNumber = 0;
		int hotelID = 0;
		OrderVO ovo=new OrderVO(hotelID, hotelID, hotelID, null, hotelID, null, hotelID, setTime, checkOut, checkOut);
		...
		OrderVO orderVO= orderBLService.create(hotelID, hotelID, orderStatus, null, hotelID, pvo, setTime, checkOut, checkOut);
